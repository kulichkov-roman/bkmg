...
<?endif?>
        ...
        <div class="h-block"> <div class="h-left"></div><h2>Лучшие предложения</h2><div class="h-right"></div> </div>
	...
	?>
                ...
                <li id="<?=$this->GetEditAreaId($arElement['ID']);?>" data-id="id-1" class="">
    ...
    <? endforeach;?>           
            ...
            <div class="but-all-item"><a href="/catalog.php"> Все букеты </a></div>
